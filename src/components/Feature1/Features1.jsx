    ...
    <section className="flex mx-2 md:mx-4 flex-col items-center gap-12 pt-24">
      ...
      <div className="img-container relative">
        <div className="img-section relative">
          <img className="  lg:w-[80%] m-auto" src="/Features1/desktop.svg" />
          <img
            className="mobile absolute top-36 z-2 h-[85%] w-[35%] md:top-30 md:w-[30%] "
            src="/Features1/iPhone.svg"
          />
        </div>
        ...
        <div className="cards flex flex-wrap gap-6 pt-20 py-10 ">
          <div className="card1n2 flex lg:mx-auto flex-wrap md:flex-wrap mx-auto justify-center">
            <div className="cards1  w-96  text-center sm:py-10">
              ...
              <p className=" text-xl">Share team inboxes</p>
              <p className=" text-base text-[#667085] text-center">
                Whether you have a team of 2 or 200, our shared team inboxes
                keep everyone on the same page and in the loop.
              </p>
              <button className="bottom flex items-center mx-auto text-[#6941C6]">
                {" "}
            ...
            <div className="cards2 w-96 text-center mt-10">
              ...
              <p className=" text-xl">Deliver instant answers</p>
              <p className=" text-base text-[#667085] text-center">
                An all-in-one customer service platform that helps you balance
                everything your customers need to be happy.
              </p>
              <button className="bottom flex mx-auto text-[#6941C6]">
                Learn more <img src={arrow} className="" alt="" />
              </button>
            </div>
          </div>
          <div className="cards3 flex-col w-96 text-center mt-9 lg:flex mx-auto m-5">
            ...
            <p className=" text-xl">Manage your team with reports</p>
            <p className=" text-base text-[#667085] text-center">
